// Package htmltoimage provides a Go client for the HTML to Image API.
//
// For more information, visit: https://htmltoimage.apiverve.com?utm_source=go&utm_medium=readme
package htmltoimage
...
const (
	baseURL        = "https://api.apiverve.com/v1/htmltoimage"
	defaultTimeout = 30 * time.Second
)

// Client is the HTML to Image API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new HTML to Image API client.
...
// Execute makes a request to the HTML to Image API with typed parameters.
//
...
//   - html (required): string - HTML code to convert [maxLength: 500000]
