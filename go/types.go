...
// Request contains the parameters for the HTML to Image API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"html": {Type: "string", Required: true, MaxLength: intPtr(500000)},
...
// ResponseData contains the data returned by the HTML to Image API.
