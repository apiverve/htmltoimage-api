...
namespace APIVerve\Htmltoimage;
...
/**
 * Client for the HTML to Image API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://htmltoimage.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/htmltoimage';
    ...
    private const VALIDATION_RULES = [
        ...
        'width' => ['type' => 'integer', 'required' => false, 'min' => 100, 'max' => 3840],
        'height' => ['type' => 'integer', 'required' => false, 'min' => 100, 'max' => 2160],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HtmltoimageClient] {$message}\n";
        }
    }
}
