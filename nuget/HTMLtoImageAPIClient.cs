...
namespace APIVerve.API.HTMLtoImage
{
    ...
    /// <summary>
    /// Client for the HTMLtoImage API
    /// </summary>
    public class HTMLtoImageAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/htmltoimage";
        ...
        {
            { "html", new ValidationRule { Type = "string", Required = true, MaxLength = 500000 } },
            { "width", new ValidationRule { Type = "integer", Required = false, Min = 100, Max = 3840 } },
            { "height", new ValidationRule { Type = "integer", Required = false, Min = 100, Max = 2160 } },
            { "format", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public HTMLtoImageAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLtoImageAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLtoImageAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTMLtoImageQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HTMLtoImageQueryOptions options)
        {
        ...
        public ResponseObj Execute(HTMLtoImageQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HTMLtoImageQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HTMLtoImageQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HTMLtoImageQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HTMLtoImageQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HTMLtoImageQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HTMLtoImageQueryOptions options)
        {
